    ...
    <div className="relative isolate px-6 pt-14 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        <div className="hidden sm:mb-8 sm:flex sm:justify-center">
          <div className="relative rounded-full px-3 py-1 text-sm/6 text-text-muted ring-1 ring-text-muted/50 hover:ring-text-muted/60">
        ...
        <div className="text-center">
          <h1 className="text-5xl font-semibold font-bricolage-grotesque tracking-tight text-balance text-text sm:text-7xl">
            Explore Bangladesh like Never Before
          </h1>
          <p className="mt-8 text-lg font-medium text-pretty text-text-muted sm:text-xl/8">
            Your journey starts here — from Sundarbans to Sylhet, <br /> we guide your way.
          </p>
          <div className="mt-10 flex items-center justify-center gap-x-6">
            ...
            <Link to="#" className="text-sm/6 font-semibold text-text hover:text-brand ">
