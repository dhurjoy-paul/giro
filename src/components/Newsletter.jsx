      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            <h2 className="text-4xl font-bricolage-grotesque font-semibold tracking-tight text-text">Subscribe to our newsletter</h2>
            ...
            <div className="mt-6 flex max-w-md gap-x-4">
              ...
              <input
                ...
                autoComplete="email"
                className="min-w-0 flex-auto rounded-md bg-bg-light px-3.5 py-2 text-base text-text placeholder:text-text-muted outline-1 -outline-offset- outline-text/10 focus:outline-2 focus:-outline-offset-2 focus:outline-brand"
              />
              <button
                type="submit"
          ...
          <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div className="flex flex-col items-start group">
              <div className="rounded-md bg-text/5 p-2 ring-1 ring-text/10 group-hover:bg-brand/8 group-hover:ring-brand/10">
                <MdHistoryEdu aria-hidden="true" className="size-6 text-text group-hover:text-brand" />
              </div>
            ...
            <div className="flex flex-col items-start group">
              <div className="rounded-md bg-text/5 p-2 ring-1 ring-text/10 group-hover:bg-brand/8 group-hover:ring-brand/10">
                <HiOutlineHandRaised aria-hidden="true" className="size-6 text-text group-hover:text-brand" />
              </div>
